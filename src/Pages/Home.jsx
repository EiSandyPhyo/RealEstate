              ...
              <div className="w-[70%] bg-white dark:bg-[#0F172A] dark:text-white text-black  rounded-t-xl px-6 py-4 h-fit flex justify-start items-center lg:w-fit">
                <button
                  ...
                  className={` w-[80px] h-[40px] fs-[17px] leading-[24px] rounded-lg${
                    showBuyBtnColor ? "bg-[#16a34a] text-white" : " hover:text-[#16a34a] "
                  }`}
                >
                  Buy
                </button>
                <button
                  onClick={SellHandler}
                  className={` w-[80px] h-[40px] fs-[17px] leading-[24px] rounded-lg   ${
                    showSellBtnColor ? "bg-[#16a34a] text-white" : "hover:text-[#16a34a]"
                  }`}
                >
                  Sell
                </button>
                <button
                  onClick={ RentHandler}
                  className={` w-[80px] h-[40px] fs-[17px] leading-[24px] rounded-lg ${
                    showRentBtnColor ? "bg-[#16a34a] text-white" : " hover:text-[#16a34a] "
                  }`}
                >
                  Rent
                </button>
