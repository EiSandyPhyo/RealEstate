...
const ImagesModal = ({ showModal, setShowModal }) => {
  //error တက်နေတယ်
    ...
    <>
      <div className="container-fluid   ">
          ...
          <div className="md:w-1/2 lg:w-1/2 p-1">
            <div className="group relative overflow-hidden">
              ...
              <div className="">
                <img
                  className=""
                  src="https://hously-react.vercel.app/static/media/1.308efca6fd5d5670dd0c.jpg"
                  alt=""
                />
                <div className="absolute top-1/2 -translate-y-1/2 start-1/2 end-1/2 text-center invisible group-hover:visible">
                  <button
                    id="btn"
                    onClick={() => toggleModal("1", "308efca6fd5d5670dd0c")}
        ...
        <div
          className={
            showModal
              ? "fixed top-0 left-0 z-80 w-screen h-screen bg-black/70 flex  justify-center items-center"
              : "hidden"
          }
        >
          <a
