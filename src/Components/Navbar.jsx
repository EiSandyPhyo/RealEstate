...
const Navbar = () => {
  ...
  return (
    <div
      className=" container relative duration-[1500ms] h-[80px]"
      id="mystart"
    >
      <div className=" container mx-auto myGlassBg dark:bg-[#0F262E] fixed top-0 lg:right-28 py-4 h-[70px]  flex justify-between items-center z-50">
        <div>
          <img
        ...
        <div className=" flex justify-end items-center">
          <div className="">
            <ul className="hidden lg:flex justify-end items-center mr-5 ">
              <Link to={"/home"}>
              ...
              <li onClick={()=>setShowDeskMenu(!showDeskMenu)} className=" w-fit h-[40px] flex justify-center items-center mx-3 cursor-pointer relative myliForDropDown">
                <span className=" fs-[17px] font-medium text-black dark:text-white hover:text-[#16a34a]">
                  Pages
                </span>
                <BsChevronDown
                  ...
                  color="black"
                />
                <div className={` ${showDeskMenu? '':'hidden'}  bg-white w-[150px] absolute top-[38px] left-0 shadow-lg p-5 rounded-md dark:bg-[#0F172A] z-50`}>
                  <ul>
                    <Link to={""}>
              ...
              <li className=" w-fit h-[40px] flex justify-center items-center mx-3 cursor-pointer relative myliForDropDown">
                ...
                {/*
                <div className="hidden hover:block bg-white w-[150px] absolute top-[38px] left-0 shadow-lg p-5 rounded-md dark:bg-[#0F172A] z-50">
                  <ul>
                    <li className="fs-[17px] font-medium text-black dark:text-white hover:text-[#16a34a] mb-2">
                      List Sidebar
                    </li>
                    <li className=" hover:text-[#16a34a] fs-[17px] font-medium text-black dark:text-white ">
                      Property Detail
                    </li>
                  </ul>
                </div>
  */}
          ...
          <div className=" flex justify-end items-start">
            <Link to={"/"}>
              <button className=" w-10 h-10 p-2 fs-[17px] leading-[24px] border-0 text-white bg-[#16a34a] hover:bg-[#138a3f] rounded-full mx-1">
                <BiUser size={"1.5rem"} />
              </button>
            </Link>
            <Link to={"/signup"}>
            ...
            <Link to={""}>
              <div className=" block lg:hidden  myliForDropDown">
                <button
                ...
                <div
                  ...
                  } bg-white absolute top-[68px] right-0 p-5  rounded-md w-[90%] shadow-xl dark:bg-[#0F172A] `}
                >
                  <ul>
      ...
      <div>
        <a href="#mystart" className="duration-[1500ms]	">
          <button className=" fixed right-[1%] bottom-[15%] w-10 h-10 p-2 fs-[17px] leading-[24px] border-0 text-white bg-[#16a34a] hover:bg-[#138a3f] rounded-full mx-1 z-50">
