    ...
    <div className=" container-fluid bg-[#0F172A] dark:[#1E293B] relative">
      ...
      <div className="container-fluid w-[90%] lg:w-[55%] p-4 absolute -top-20 left-[50%] translate-x-[-50%] mb-10 overflow-hidden bg-white dark:drop-shadow-[0_10px_10px_rgba(2555,255,255,0.25)] drop-shadow-[0_30px_30px_rgba(0,0,0,0.25)] rounded-xl dark:bg-slate-900 ">
        <div className="container-2xl flex flex-col lg:flex-row gap-3 md:p-10 justify-between items-center relative ">
          ...
          <div className="basis-1/2 flex gap-3 border-2 pl-3 border-slate-200 dark:border-slate-50 rounded-full lg:w-[500px] overflow-hidden z-20">
            <input
              type="text"
          ...
          <div className=" basis-3/12 fs-[17px] mb-3">
            ...
            <div>
              ...
              <div className=" mb-3 flex justify-start item-center">
                ...
                <p className=" text-gray-300 hover:text-slate-400 mb-3 ml-5">
                  {" "}
                  contact@gmail.com
                </p>
              </div>
            ...
            <div className=" ">
              <Link to={""}>
                <button className=" w-10 h-10 p-2 fs-[17px] leading-[24px] text-slate-400 hover:text-white border-0 hover:bg-[#138a3f] rounded-lg myFooterBtn">
                  <AiOutlineShoppingCart size={"1rem"} />
                </button>
              </Link>

              <Link to={""}>
                <button className=" w-10 h-10 p-2 fs-[17px] leading-[24px] text-slate-400 hover:text-white border-0 hover:bg-[#138a3f] rounded-lg myFooterBtn">
                  <FiDribbble size={"1rem"} />
                </button>
              </Link>
              <Link to={""}>
                <button className=" w-10 h-10 p-2 fs-[17px] leading-[24px] text-slate-400 hover:text-white border-0 hover:bg-[#138a3f] rounded-lg myFooterBtn">
